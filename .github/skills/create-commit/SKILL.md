...
When creating a git commit for this repository, format a commit message that follows the Conventional Commits specification, verify git status/staged changes,
and execute the git commit command.
